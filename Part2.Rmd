...
A linear model may be appropriate for the regression variables ADL, MEM and COG. The relationship would be scattered for all three variables. The relation for ADL and MEM would be positive. The relation for COG would be negative.
